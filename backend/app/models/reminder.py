...
class ScheduledReminder(Base):
    ...
    # 🎯 RELACIÓN CON CASCADE: Si se borra la reserva, se borra el recordatorio
    ...
    # Relación opcional para acceder a los datos de la reserva desde el recordatorio
    reservation = relationship("Reservation", back_populates="reminders")
